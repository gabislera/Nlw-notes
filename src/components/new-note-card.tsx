...
export function NewNoteCard({ onNoteCreated }: NewNoteCard) {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className="rounded-md hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400 flex flex-col bg-slate-700 p-5 text-left gap-3 outline-none">
